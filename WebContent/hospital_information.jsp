...
<%
	if (session.getAttribute("id") == null) {
		...
		try {
			...
			// 질의 준비
			stmt = conn
					.prepareStatement("SELECT * FROM hospitals WHERE hospital_id = ?");
	...
	<div id="wrap">
		<div id="header">
			...
			<div id="header_right">
				...
				<b><%=session.getAttribute("id")%></b>님 환영합니다<br> <a
					href="hospital_information.jsp" class="btn btn-mini">MyPage</a> <a
					href="logout.jsp" class="btn btn-mini">로그아웃</a>
				<%
					}
				%>
			</div>
